...
if (faturamentoSalvo) {
  faturamentoInput.value = faturamentoSalvo;
}

faturamentoInput.addEventListener("input", function () {
  localStorage.setItem(getChaveFaturamentoFuncionarios(), faturamentoInput.value);
...
var faturamento = numeroFuncionario(getValueFuncionario("faturamentoMensalInput"));
...
var faturamento = numeroFuncionario(localStorage.getItem(getChaveFaturamentoFuncionarios()));
...
setTextFuncionario("totalClt", moedaFuncionario(totalClt));
setTextFuncionario("totalFreelancers", moedaFuncionario(totalFreelancers));
setTextFuncionario("totalMaoObra", moedaFuncionario(totalMaoObra));
...
setTextFuncionario("custoMedioHora", moedaFuncionario(custoMedioHora));
