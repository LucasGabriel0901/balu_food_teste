...
function renderizarResumoEmbalagens() {
  ...
  var valorEstoque = embalagensCache.reduce(function (soma, embalagem) {
    return soma + numeroEmbalagem(embalagem.valorEstoque);
  }, 0);

  var estoqueBaixo = obterEmbalagensComAlertaEstoque().length;

  setTextEmbalagem("totalEmbalagens", total);
  setTextEmbalagem("valorEstoqueEmbalagens", formatarMoedaEmbalagem(valorEstoque));
  setTextEmbalagem("embalagensEstoqueBaixo", estoqueBaixo);
